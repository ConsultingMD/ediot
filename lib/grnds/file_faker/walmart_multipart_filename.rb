...
module Grnds
  module FileFaker
    ...
    class WalmartMultipartFilename < Filename
      ...
      # Generate the final file name so that its embedded timestamp is roughly
      # 23 hours later than the timestamp embedded in any other file name
      # generated by this instance.
      def next_file
        super.tap do |name|
          @now += 23.hours if @next == @nfiles
        end
      end
    end
  end
